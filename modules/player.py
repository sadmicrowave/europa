...
class Player:
	...
	def __init__(self, world):
		...
		self.skills	= {	'attack':
						...
						,'block':
							{'name':'Blocking'
							 ,'desc':'Rate at which equipped armor resists degradation from attacks.'
							 ,'value':20
							 }
						,'awareness':
							{'name':'Awareness'
							,'desc':'Level at which you can sense abnormalities and hazards in your surroundings.'
							,'value':0
							}
						}		
...
# 	def pick_up(self, item=None, **kwargs):
...
# 	def drop(self, item=None, **kwargs):
# 		# check if an item has been passed to the method. This function does not work without an item to interact with
# 		if item:
# 			# attempt to find the item the user wants to interact with in the container/room
...
# 	def open(self, item=None, **kwargs):
# 		# check if an item has been passed to the method. This function does not work without an item to interact with
# 		if item:
# 			# attempt to find the item the user wants to interact with in the container/room
# 			item = self.select_item(item, self.room.get_items())
...
# 					Health.increase_health(self, item.hp)
...
# 	def repair(self, vendor, item=None, **kwargs):
# 		# check if an item has been passed to the method. This function does not work without an item to interact with
# 		if item :
# 			# attempt to find the item the user wants to interact with in the container/room
# 			item = self.select_item(item, self.inventory)
...
# 
# 	def buy(self, merchant, item=None, **kwargs):
# 		# check if an item has been passed to the method. This function does not work without an item to interact with
# 		if item:
# 			# attempt to find the item the user wants to interact with in the container/room
...
# 	
# 	
# 	def sell(self, merchant, item=None, **kwargs):
# 		# check if an item has been passed to the method. This function does not work without an item to interact with
# 		if item:
# 			# attempt to find the item the user wants to interact with in the container/room
# 			item = self.select_item(item, self.inventory)
